/****************************************************************************
** HW_CounterWizardPanel meta object code from reading C++ file 'HW_CounterWizardPanel.hxx'
**
** Created: Wed Mar 5 17:48:13 2014
...
const char *HW_CounterWizardPanel::className() const
{
    return "HW_CounterWizardPanel";
}

QMetaObject *HW_CounterWizardPanel::metaObj = 0;
static QMetaObjectCleanUp cleanUp_HW_CounterWizardPanel( "HW_CounterWizardPanel", &HW_CounterWizardPanel::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString HW_CounterWizardPanel::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "HW_CounterWizardPanel", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString HW_CounterWizardPanel::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "HW_CounterWizardPanel", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* HW_CounterWizardPanel::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	"HW_CounterWizardPanel", parentObject,
	slot_tbl, 25,
	0, 0,
	...
	0, 0 );
    cleanUp_HW_CounterWizardPanel.setMetaObject( metaObj );
    return metaObj;
}

void* HW_CounterWizardPanel::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "HW_CounterWizardPanel" ) )
	return this;
    return Panel::qt_cast( clname );
}

bool HW_CounterWizardPanel::qt_invoke( int _id, QUObject* _o )
{
...
bool HW_CounterWizardPanel::qt_emit( int _id, QUObject* _o )
{
    return Panel::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool HW_CounterWizardPanel::qt_property( int id, int f, QVariant* v)
{
    return Panel::qt_property( id, f, v);
}

bool HW_CounterWizardPanel::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
