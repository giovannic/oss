/****************************************************************************
** FPE_TracingWizardPanel meta object code from reading C++ file 'FPE_TracingWizardPanel.hxx'
**
** Created: Wed Mar 5 17:48:00 2014
...
const char *FPE_TracingWizardPanel::className() const
{
    return "FPE_TracingWizardPanel";
}

QMetaObject *FPE_TracingWizardPanel::metaObj = 0;
static QMetaObjectCleanUp cleanUp_FPE_TracingWizardPanel( "FPE_TracingWizardPanel", &FPE_TracingWizardPanel::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString FPE_TracingWizardPanel::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FPE_TracingWizardPanel", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString FPE_TracingWizardPanel::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FPE_TracingWizardPanel", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* FPE_TracingWizardPanel::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	"FPE_TracingWizardPanel", parentObject,
	slot_tbl, 27,
	0, 0,
	...
	0, 0 );
    cleanUp_FPE_TracingWizardPanel.setMetaObject( metaObj );
    return metaObj;
}

void* FPE_TracingWizardPanel::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "FPE_TracingWizardPanel" ) )
	return this;
    return Panel::qt_cast( clname );
}

bool FPE_TracingWizardPanel::qt_invoke( int _id, QUObject* _o )
{
...
bool FPE_TracingWizardPanel::qt_emit( int _id, QUObject* _o )
{
    return Panel::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool FPE_TracingWizardPanel::qt_property( int id, int f, QVariant* v)
{
    return Panel::qt_property( id, f, v);
}

bool FPE_TracingWizardPanel::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
