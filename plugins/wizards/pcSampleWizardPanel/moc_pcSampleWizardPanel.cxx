/****************************************************************************
** pcSampleWizardPanel meta object code from reading C++ file 'pcSampleWizardPanel.hxx'
**
** Created: Wed Mar 5 17:47:52 2014
...
const char *pcSampleWizardPanel::className() const
{
    return "pcSampleWizardPanel";
}

QMetaObject *pcSampleWizardPanel::metaObj = 0;
static QMetaObjectCleanUp cleanUp_pcSampleWizardPanel( "pcSampleWizardPanel", &pcSampleWizardPanel::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString pcSampleWizardPanel::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "pcSampleWizardPanel", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString pcSampleWizardPanel::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "pcSampleWizardPanel", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* pcSampleWizardPanel::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
    ...
    static const QUMethod slot_18 = {"instrumentorIsOfflineModeSelected", 0, 0 };
    static const QUMethod slot_19 = {"wizardModeSelected", 0, 0 };
    static const QUMethod slot_20 = {"finishButtonSelected", 0, 0 };
	...
	{ "instrumentorIsOfflineModeSelected()", &slot_18, QMetaData::Public },
	{ "wizardModeSelected()", &slot_19, QMetaData::Public },
	{ "finishButtonSelected()", &slot_20, QMetaData::Public },
	...
	"pcSampleWizardPanel", parentObject,
	slot_tbl, 26,
	0, 0,
	...
	0, 0 );
    cleanUp_pcSampleWizardPanel.setMetaObject( metaObj );
    return metaObj;
}

void* pcSampleWizardPanel::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "pcSampleWizardPanel" ) )
	return this;
    return Panel::qt_cast( clname );
}

bool pcSampleWizardPanel::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 18: instrumentorIsOfflineModeSelected(); break;
    case 19: wizardModeSelected(); break;
    case 20: finishButtonSelected(); break;
...
bool pcSampleWizardPanel::qt_emit( int _id, QUObject* _o )
{
    return Panel::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool pcSampleWizardPanel::qt_property( int id, int f, QVariant* v)
{
    return Panel::qt_property( id, f, v);
}

bool pcSampleWizardPanel::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
