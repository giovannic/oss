...
/*                                                                            */
/******************************************************************************/
#pragma comment(copyright,"5765-543 (C) Copyright IBM Corp. 1998 $Source: /cvsroot/openss/OpenSpeedShop/test/src/dpcl/diag/eut_diag.cxx,v $ $Id: eut_diag.cxx,v 1.1 2006/04/13 22:30:14 jeg Exp $ $Date: 2006/04/13 22:30:14 $ %Z% %I% %W% %D% %T%")
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
/*  
